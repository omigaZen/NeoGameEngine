...
`ModelImporter::version()` 当前为 `53`，覆盖 manifest/OBJ 解析、OBJ relative index 解析、OBJ homogeneous vertex coordinate parsing、OBJ inline comment parsing、model mesh optimization degenerate-triangle culling、
